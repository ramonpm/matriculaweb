...
class TurmasControllerTest < ActionController::TestCase
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post :create, turma: { dias_horarios: @turma.dias_horarios, disciplina_id: @turma.disciplina_id }
    end
  ...
  test "should update turma" do
    put :update, id: @turma, turma: { dias_horarios: @turma.dias_horarios, disciplina_id: @turma.disciplina_id }
    assert_redirected_to turma_path(assigns(:turma))
  end
